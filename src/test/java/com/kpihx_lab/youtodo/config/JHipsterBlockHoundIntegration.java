package com.kpihx_lab.youtodo.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.kpihx_lab.youtodo.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.kpihx_lab.youtodo.security.DomainUserDetailsService", "createSpringSecurityUser");
