...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tache.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TACHE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TACHE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TACHE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TACHE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TACHE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TACHE actions', async () => {
      const arg = 42666;
