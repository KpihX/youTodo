...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './categorie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATEGORIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CATEGORIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CATEGORIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CATEGORIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CATEGORIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CATEGORIE actions', async () => {
      const arg = 42666;
