...
export const CategorieDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="youTodoApp.categorie.delete.question">
        <Translate contentKey="youTodoApp.categorie.delete.question" interpolate={{ id: categorieEntity.id }}>
